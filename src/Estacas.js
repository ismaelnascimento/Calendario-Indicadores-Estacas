...
import "./styles/estacas.css";

function Estacas({ unidades }) {
  const filterEstacas = useMemo(() => {
  ...
  return (
    <div className="calendario--home">
      ...
      <div className="calendario--home__list">
        {filterEstacas?.map((estaca) => (
          <div onClick={() => (window.location.href = `/${estaca?.estacaUID}`)}>
            <div>
              <CalendarIcon />
              <p>{estaca?.ano}</p>
            </div>
